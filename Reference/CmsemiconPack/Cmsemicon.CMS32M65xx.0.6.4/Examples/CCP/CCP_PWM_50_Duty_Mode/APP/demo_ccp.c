...
/*****************************************************************************
 ** \brief	CCP_50_DUTY_Config
 **			
 ** \param [in] none
 ** \return  none
 ** \note	
*****************************************************************************/
void CCP_50_DUTY_Config(void)
{
	/*
	(1)设置CCP的时钟
	*/
	...
	*/
	...
	(3)设置50%占空比输出
	*/	
	CCP_EnablePWMHalfCycleMode(CCP0,CCPxA);
	CCP_EnablePWMHalfCycleMode(CCP0,CCPxB);	
	CCP_EnablePWMHalfCycleMode(CCP1,CCPxA);	
	CCP_EnablePWMHalfCycleMode(CCP1,CCPxB);	
	/*
	(4)设置CCP 反相输出
	*/		
