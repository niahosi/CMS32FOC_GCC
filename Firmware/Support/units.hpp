...
template <int32_t CountsPerRev> constexpr SpeedCounts rpm_to_speed_counts(Rpm rpm) noexcept
{
...
template <int32_t CountsPerRev> constexpr Rpm speed_counts_to_rpm(SpeedCounts speed) noexcept
{
    static_assert(CountsPerRev > 0, "CountsPerRev must be positive");
