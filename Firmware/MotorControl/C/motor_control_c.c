...
static void fill_watch(MotorControlWatch_t* out)
{
    ...
    out->sample_pair = curr_pair();
    out->sample_hold = curr_is_hold();
    out->sample_hold_count = curr_hold_count();
    out->sample_common_window = curr_window_common();
    out->sample_switch_count = curr_sample_switch_count();
    out->sample_center_bias = curr_sample_center_bias();
    out->sample_tick_a = curr_sample_tick_a();
    out->sample_tick_b = curr_sample_tick_b();
    out->sample_single_point = curr_sample_single_point();
    out->sample_region = curr_sample_region();
    ...
    out->sample_spread0 = curr_diag_spread0();
    out->sample_spread1 = curr_diag_spread1();
    out->iv_spike_count = curr_iv_spike_count();
    out->iw_spike_count = curr_iw_spike_count();
    out->iv_max_step = curr_iv_max_step();
    out->iw_max_step = curr_iw_max_step();
                                   ...
                                   const MotorControlWatch_t* src)
{
    ...
    dst->sample_pair = src->sample_pair;
    dst->sample_hold = src->sample_hold;
    dst->sample_hold_count = src->sample_hold_count;
    dst->sample_common_window = src->sample_common_window;
    dst->sample_switch_count = src->sample_switch_count;
    dst->sample_center_bias = src->sample_center_bias;
    dst->sample_tick_a = src->sample_tick_a;
    dst->sample_tick_b = src->sample_tick_b;
    dst->sample_single_point = src->sample_single_point;
    dst->sample_region = src->sample_region;
    ...
    dst->sample_spread0 = src->sample_spread0;
    dst->sample_spread1 = src->sample_spread1;
    dst->iv_spike_count = src->iv_spike_count;
    dst->iw_spike_count = src->iw_spike_count;
    dst->iv_max_step = src->iv_max_step;
    dst->iw_max_step = src->iw_max_step;
